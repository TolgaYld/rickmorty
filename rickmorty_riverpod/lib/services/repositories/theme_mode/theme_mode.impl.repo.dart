...
import 'package:rickmorty_riverpod/services/datasources/theme_mode/local/theme_mode.impl.datasource.dart';
...
final themeModeRepositoryProvider = Provider.autoDispose<ThemeModeRepository>(
  (ref) => ThemeModeRepositoryImpl(ref.watch(themeModeDatasourceProvider)),
);

class ThemeModeRepositoryImpl implements ThemeModeRepository {
  ThemeModeRepositoryImpl(this._datasource);
  final ThemeModeDatasource _datasource;
